...
class HostPanel(QWidget):
    """
    A widget that displays the list of hosts and their options.
    """
    connect_to_host_requested = pyqtSignal(HostBlock)
    ...
    def _build_details_panel(self) -> QWidget:
        ...
        copy_button.clicked.connect(self._copy_ssh_command)
    ...
    def _build_ssh_command(self, block: HostBlock) -> str:
        tokens = self.get_ssh_command_tokens(block)
    ...
    def _build_host_list_panel(self) -> QWidget:
        ...
        self._host_filter.textChanged.connect(self._apply_host_filter)
        ...
        self._host_list = QListWidget()
        self._host_list.currentRowChanged.connect(self._show_host_details_from_list)
        ...
        self._host_list.customContextMenuRequested.connect(self._show_host_context_menu)
        
        # Tree view grouped by tags
        self._host_tree = QTreeWidget()
        self._host_tree.setHeaderHidden(True)
        self._host_tree.currentItemChanged.connect(self._show_host_details_from_tree)
        ...
        self._host_tree.customContextMenuRequested.connect(self._show_host_context_menu_tree)
    ...
    def _build_options_panel(self) -> QWidget:
        ...
        self._options_table.cellDoubleClicked.connect(self._edit_option)
        ...
        self._options_table.customContextMenuRequested.connect(self._show_option_context_menu)
        ...
        open_button.clicked.connect(self._open_host_file)
    ...
    def get_ssh_command_tokens(self, block: HostBlock) -> List[str]:
    ...
    def _connect_to_host(self) -> None:
        ...
        self.connect_to_host_requested.emit(block)
